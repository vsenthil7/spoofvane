...
| UI pages | 21/21 | **21/21 React source, tsc-clean** | Playwright pixel-diff = BLOCKED-ENV |
| Unit/integration tests | 100% | **348 passing, 2 skip** | +125 over v0.4 baseline (223) |
| E2E Playwright | 21 pages | 6 specs (need live server) | server fixture = follow-up |
| Supply chain | SBOM+SLSA | **SBOM real (26 comp)** | SLSA signing = BLOCKED-ENV |
...
python -m pytest --ignore=tests/e2e -q # 348 passing
